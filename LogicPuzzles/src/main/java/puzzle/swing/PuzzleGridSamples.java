...
public class PuzzleGridSamples {
   private Map<String, Integer[][]> samples = new LinkedHashMap<String, Integer[][]>();
   private static PuzzleGridSamples INSTANCE;
   
   private PuzzleGridSamples() {
      samples.put
      (
        "Simple",
        new Integer[][] 
   ...
   public static PuzzleGridSamples getInstance(){
      if (INSTANCE == null){
         INSTANCE = new PuzzleGridSamples();
      }
      return INSTANCE;
   }
